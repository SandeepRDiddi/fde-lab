...
| FDE-002 | Time-box scheduler | P0 | FDE-001 | Done |
| FDE-003 | Synthetic data generator v1 | P0 | — | Done |
| FDE-004 | AI persona service | P0 | FDE-001 | In review |
| FDE-005 | Legacy API mock service | P1 | — | In review |
| FDE-006 | Compliance checklist engine | P1 | — | In review |
...
| FDE-011 | LTI 1.3 launch service | P1 | FDE-001 | In review |
